...
public class UpdatedPasswordValidator {
    ...
    public UpdatedPasswordValidator(String username, String currentPassword) {
    ...
    public static UpdatedPasswordValidator login(){
        ...
        return new UpdatedPasswordValidator(username, password);
    }
